...
content_disc_opt = torch.optim.RMSprop(content_disc_params, lr=1e-3)
# style discriminaot/adversary optimizer
style_disc_opt = torch.optim.RMSprop(style_disc_params, lr=1e-3)
# autoencoder and classifiers optimizer
vae_and_cls_opt = torch.optim.Adam(vae_and_classifiers_params, lr=1e-3)
